...
class EngineWrapper:
    ...
    def get_stats(self):
        ...
        stats = ["depth", "seldepth", "nps", "nodes", "tbhits", "score", "time"]
...
class UCIEngine(EngineWrapper):
    ...
    def set_hash(self, hash_):
        self.engine.setoption({"Hash":hash_})

    def nnue_new(self):
        self.engine.protocol.send_line("setoption name EvalFile value nn-7e66505906a6.nnue")
